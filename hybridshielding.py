...
def replace(netlist, selected_gates, t, output, inputs, outputs, percent):
    newfile = "%s" % output
    if percent == 0:
        randomoutputs = []
    else:
                ...
                if len(s) > 0:
                    ...
                    if s[0] in selected_gates:
                        ...
                        if i == 45:
                            ...
                            # after writing internal state block, write big SAT-Resilient Block output—AND with Internal State Block to create the input for Reinstate block
