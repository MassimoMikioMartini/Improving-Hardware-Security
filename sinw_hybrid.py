def make(line, n, inputs):
    ...
    i1 = "i1_%d = NOR(%s, %s)" % (n, a, b) # a NOR b
    i2 = "i2_%d = XOR(%s, %s)" % (n, a, b) # a XOR b
    i3 = "i3_%d = XNOR(%s, %s)" % (n, a, b) # a XNOR b
    ...
    and3 = "and3_%d = AND(i3_%d, %s, %s)" % (n, n, keys[0], keys[1])

    output = "%s = OR(and0_%d, and1_%d, and2_%d, and3_%d)" % (total_output, n, n, n, n)
